...
<a href="/">飞鱼首页</a> <span class='separator'>></span> <a href="/vps.html">主机</a> <span class='separator'>></span> <span>{{$log.cprodname}}</span></div>
<!-- breadcrumbs -->
          ...
          <div class="boxbottom">
               <div class="boxbottomleft">
                    <div class="productparameter">
                       <p><span>></span><lable>操作系统：</lable> {{$log.sys}}</p>
                       <p><span>></span><lable>支持语言：</lable>{{$log.lan}}</p>
                       <p><span>></span><lable>数据库：</lable>Mysql &nbsp;<span class="strong">{{$log.db}}</span></p>
                       <p><span>></span><lable>空间大小：</lable><span class="strong">{{$log.host}}</span></p>
                       <p><span>></span><lable>月流量：</lable>{{$log.rate}}</p>
                     </div>
               </div>
               <dl class="boxbottomright">
                   <dd>
                    <div class="productparameter">
                       <p><font>{{$log.price}}元/年</font></p>
                       <p>2年&nbsp;{{$log.price*2*0.85}}元&nbsp;立省 <span class="red">{{$log.price*2-$log.price*2*0.85}}</span>元</p>
                       <p>3年&nbsp;{{$log.price*3*0.80}}元&nbsp;立省 <span class="red">{{$log.price*3-$log.price*3*0.80}}</span>元</p>
                       <input type="button" class="listinput" onclick="addcart('{{$log.id}}','vps')" value="加入购物车" />
                     </div>
                   </dd>
