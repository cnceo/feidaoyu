       ...
       $.validator.setDefaults({
			 submitHandler: function() {
			 	...
			 	var data = $("#myForm").formToArray();
						$.ajax({
						type: "POST",
						url:  "?m={{'brand'|encrypt}}&a=savePost",
						data: data,
						dataType: 'json', 
						success: function(msg){
							    ...
							    if(msg.status == "true")
								    {
										   $("#{{$smarty.get.keyname}}", window.parent.document).prepend("<option value='"+msg.id+"' selected>"+$("#cname").val()+"</option");
      ...
      <div id="tab_general" style="display: block;">
        <div class="htabs" id="languages">
                ...
                <div id="language1" style="display: block;">
			          <table class="form">
			            <tbody><tr>
			              <td><span class="required">*</span> 品牌名称:</td>
        ...
        <table class="form">
          <tbody><tr>
            ...
            <input type="hidden" id="picpath" value="" name="picpath">
              <img onclick="dotb('{{$langs.upload}}', '?m={{'upload'|encrypt}}&keepThis=true&TB_iframe=false&height=422&width=800');return false;" class="image" id="preview" alt="" src="./images/no_image-100x100.jpg"></td>
          </tr>
		  <tr>
            <td>品牌状态:</td>
