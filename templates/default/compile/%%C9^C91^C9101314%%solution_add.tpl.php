<?php /* Smarty version 2.6.7, created on 2012-07-25 10:55:07
         compiled from admin/solution_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/solution_add.tpl', 38, false),array('function', 'html_options', 'admin/solution_add.tpl', 98, false),)), $this); ?>
...
&a=savePost",
						...
						success: function(msg){
							    ...
							    if(msg.status == "true")
								    {
										window.location= '?m=<?php echo ((is_array($_tmp='solution')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
';
								    }
								    else
								    {
...
" size="50" name="title" id="title">
			            ...
			            <tr>
			              <td><span class="required">*</span> 标题(英):</td>
			              <td><input value="<?php echo $this->_tpl_vars['log']['etitle']; ?>
" size="50" name="etitle" id="etitle">
			                </td>
			            </tr>
			            <tr>
			              <td>内容:</td>
