<?php /* Smarty version 2.6.7, created on 2012-08-15 15:53:25
         compiled from user/password.tpl */ ?>
        ...
        <div class="xiugaimima-block">
           <h3><img src="images/individual-center_40.jpg" width="78" height="17"/></h3>
            ...
            <form method="post" name="myForm" id="myForm">
               <span>原有密码：</span><input type="password" class=" password1" /><em>*</em><p>请输入原有密码</p><div class="clear"></div>
               <span>新 密 码：</span><input type="password" class=" password1" /><em>*</em><p>请设置登录密码</p><div class="clear"></div>
               <span>重复密码：</span><input type="password" class=" password1" /><em>*</em><p>重新填写密码</p><div class="clear"></div>
            </form>
