<?php /* Smarty version 2.6.7, created on 2012-08-29 12:27:20
         compiled from admin/articlecate_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/articlecate_add.tpl', 38, false),array('modifier', 'default', 'admin/articlecate_add.tpl', 163, false),array('function', 'html_options', 'admin/articlecate_add.tpl', 158, false),)), $this); ?>
...
&a=savePost",
						...
						success: function(msg){
							    ...
							    if(msg.status == "true")
								    {
										  // window.location= '?m=<?php echo ((is_array($_tmp='articlecate')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
';
