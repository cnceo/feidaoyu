<?php /* Smarty version 2.6.7, created on 2012-07-25 10:18:47
         compiled from admin/adv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/adv.tpl', 6, false),)), $this); ?>
...
{
	if(!id)id="";
	location.href="?m=<?php echo ((is_array($_tmp='adv')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
&a=add&id="+id;
}
function Del(id){
	 if(confirm("确认删除吗？"))
...
?>
          <tr>
            ...
            <td class="center"><?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['starttime']; ?>
 － <?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['endtime']; ?>
</td>
