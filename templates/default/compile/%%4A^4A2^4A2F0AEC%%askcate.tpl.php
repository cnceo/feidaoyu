<?php /* Smarty version 2.6.7, created on 2012-09-03 12:40:10
         compiled from admin/askcate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/askcate.tpl', 6, false),)), $this); ?>
...
{
	if(!id)id="";
	location.href="?m=<?php echo ((is_array($_tmp='askcate')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
&a=add&id="+id;
}
function subAdd(id)
{
