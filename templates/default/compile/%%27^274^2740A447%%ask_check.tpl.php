<?php /* Smarty version 2.6.7, created on 2012-09-03 14:28:40
         compiled from admin/ask_check.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/ask_check.tpl', 44, false),array('function', 'html_options', 'admin/ask_check.tpl', 115, false),)), $this); ?>
...
" size="100" name="title" id="title">
              ...
              <td><select name="class_id" id="class_id"><option value="">请选择...</option><?php echo $this->_tpl_vars['catelist']; ?>
			            ...
			            <tr>
			              <td> 发布用户:</td>
			              <td><?php echo $this->_tpl_vars['log']['uname']; ?>
...
" name="picpath">
           ...
           <tr>
            ...
            <td><select name="is_done">
                                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['statuslist'],'selected' => $this->_tpl_vars['log']['is_done']), $this);?>
           ...
           <tr>
            ...
            <td><select name="is_recommend">
                                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['recommendlist'],'selected' => $this->_tpl_vars['log']['is_recommend']), $this);?>
