<?php /* Smarty version 2.6.7, created on 2012-09-20 17:52:01
         compiled from user/checkout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'user/checkout.tpl', 97, false),)), $this); ?>
...
<a href="/">飞刀鱼首页</a> <span class='separator'>></span> <span>选择在线支付方式</span></div><!-- breadcrumbs -->
    ...
    <dl class="payOnline_use">
        ...
        <dt>订单：<?php echo $this->_tpl_vars['log']['order_id']; ?>
                        &nbsp;&nbsp;&nbsp;&nbsp;金额：<strong>&yen; <?php echo $this->_tpl_vars['log']['totprice']; ?>
</strong>
        </dt>
    </dl>
...
<!-- 			          <TD class=form-right><INPUT type=image
          ...
          <!--   <input type="button" value="付 款"  onclick="location.href='/user/payment.html&order_id=<?php echo $this->_tpl_vars['log']['order_id']; ?>
'" class="shopBtn" /> -->
