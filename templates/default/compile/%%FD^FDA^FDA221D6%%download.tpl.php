<?php /* Smarty version 2.6.7, created on 2012-09-03 14:20:17
         compiled from admin/download.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/download.tpl', 7, false),array('modifier', 'replace', 'admin/download.tpl', 96, false),array('modifier', 'date_format', 'admin/download.tpl', 98, false),)), $this); ?>
...
function Add(cateid,id)
{
	if(!id)id="";
	if(!cateid)cateid="";
	location.href="?m=<?php echo ((is_array($_tmp='download')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
...
<div class="box">    
  ...
  <div class="heading" style="overflow:hidden">
    <h1 style="background:url(/admin/images/article.png) no-repeat; overflow:hidden; width:160px">资源下载列表</h1>
    <div class="buttons"><a onclick="Add(<?php echo $_GET['cateid']; ?>
);" class="button"><span>添加资源下载</span></a></div>
      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="center">资源标题</td>
            <td class="center">资源分类</td>
            <td class="center">添加日期</td>
            <td class="center">资源地址</td>
...
.html" target="_blank"><?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['title']; ?>
            ...
            <td class="center"><?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['url']; ?>
</td>
