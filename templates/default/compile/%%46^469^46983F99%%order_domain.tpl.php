<?php /* Smarty version 2.6.7, created on 2012-10-18 12:06:19
         compiled from admin/order_domain.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/order_domain.tpl', 5, false),array('function', 'html_options', 'admin/order_domain.tpl', 40, false),)), $this); ?>
...
&a=domain&order_id="+$("#order_id").val()+"&email="+$("#email").val()+"&domain="+$("#domain").val()+"&status="+$("#status").val();
}
</script>
<div id="content">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" id="email"></td>
            <td class="left"><input type="text" value="<?php echo $_GET['domain']; ?>
" id="domain"></td>
            <td></td>
            <td class="center"><select id="status">
                                 <option value="">全部</option>
                                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['domainstatus'],'selected' => $_GET['status']), $this);?>
...
" />
            ...
            <td class="left"><?php echo $this->_tpl_vars['data']['domain']; ?>
</td>
            <td class="left"><?php echo $this->_tpl_vars['data']['year']; ?>
</td>
            <td class="center"><?php if ($this->_tpl_vars['data']['status'] == 1): ?>已付款<?php elseif ($this->_tpl_vars['data']['status'] == 2): ?>已经注册<?php elseif ($this->_tpl_vars['data']['status'] == 3): ?>注册失败<?php else: ?>未付款<?php endif; ?></td>
            <td class="center"><a href="?m=<?php echo ((is_array($_tmp='order')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
&a=domain_detail&id=<?php echo $this->_tpl_vars['data']['id']; ?>
