<?php /* Smarty version 2.6.7, created on 2012-07-27 09:54:04
         compiled from admin/keyword.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'encrypt', 'admin/keyword.tpl', 6, false),)), $this); ?>
...
{
	if(!id)id="";
	location.href="?m=<?php echo ((is_array($_tmp='keyword')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
&a=add&id="+id;
}
function Del(id){
	 if(confirm("确认删除吗？"))
		{
			$.ajax({
				type: "POST",
				url:  "?m=<?php echo ((is_array($_tmp='keyword')) ? $this->_run_mod_handler('encrypt', true, $_tmp) : encrypt($_tmp)); ?>
&a=del",
				data: "id="+id,
...
" />
            ...
            <td class="left"><a href="/cn/search.html&keyword=<?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['keyword']; ?>
" target="_blank"><?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['keyword']; ?>
</a></td>
            <td class="center"><input name="hits[<?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['id']; ?>
]" value="<?php echo $this->_tpl_vars['logs'][$this->_sections['data']['index']]['hits']; ?>
" size="2"></td>
