...
$partner		= "2088801477155358";

//安全检验码，以数字和字母组成的32位字符
$key   			= "yoksc3lyei2ks59jngp61d8trq81bane";

//签约支付宝账号或卖家支付宝帐户
$seller_email	= "pay@seabig.cn";

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= "http://www.feidaoyu.com/pay/alipay/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$return_url		= "http://www.feidaoyu.com/pay/alipay/return_url.php";

//网站商品的展示地址，不允许加?id=123这类自定义参数
$show_url		= "http://www.feidaoyu.com";
